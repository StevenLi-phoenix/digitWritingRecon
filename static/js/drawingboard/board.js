...
DrawingBoard.Board.prototype = {
	...
	restoreWebStorage: function() {
		if (window[this.storage] && window[this.storage].getItem('drawing-board-' + this.id) !== null && window[this.storage].getItem('drawing-board-' + this.id) !== '[object ImageData]') {
			alert(this.storage);
			alert(window[this.storage]);
			alert(window[this.storage].getItem('drawing-board-' + this.id));
			alert($("#test_object" + window[this.storage].getItem('drawing-board-' + this.id)));
